from typing import Any, NamedTuple, Union, Tuple, Optional, NoReturn, TypeVar
...
class Affine(NamedTuple):
    ...
    @classmethod
    def from_gdal(cls, c: float, a: float, b: float, f: float, d: float, e: float) -> 'Affine': ...
    @classmethod
    ...
    @classmethod
    def rotation(cls, angle: float, pivot: Optional[Tuple[float, float]] = ...) -> 'Affine': ...
    @classmethod
    ...
    @property
    def column_vectors(self) -> Tuple[Tuple[float, float], Tuple[float, float], Tuple[float, float]]: ...
